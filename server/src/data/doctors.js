...
export const doctors = [
  {
    ...
    bio: 'Dr. Thakor is the medical officer attached to the pulmonology OPD. She is usually the first doctor a family meets here, takes the initial history and chest examination, and is careful to send patients on to a specialist only when the case genuinely calls for one.',
    focus: ['Cough, breathlessness and fever', 'Asthma and COPD follow-up', 'Preventive check-ups']
  },
  {
